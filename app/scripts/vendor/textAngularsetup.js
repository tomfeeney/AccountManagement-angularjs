...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function(taRegisterTool, $window, taTranslations, taSelection){
	...
	taRegisterTool('quote', {
		iconclass: 'glyphicon glyphicon-quote-right',
	...
	taRegisterTool('undo', {
		iconclass: 'glyphicon glyphicon-undo',
	...
	taRegisterTool('underline', {
		iconclass: 'glyphicon glyphicon-underline',
	...
	taRegisterTool('strikeThrough', {
		iconclass: 'glyphicon glyphicon-strikethrough',
		action: function(){
	...
	taRegisterTool('clear', {
		iconclass: 'glyphicon glyphicon-ban',
	...
	var imgOnSelectAction = function(event, $element, editorScope){
		...
		var remove = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1"><i class="glyphicon glyphicon-trash-o"></i></button>');
	...
	taRegisterTool('insertImage', {
		iconclass: 'glyphicon glyphicon-picture-o',
	...
	taRegisterTool('insertVideo', {
		iconclass: 'glyphicon glyphicon-youtube-play',
	...
	taRegisterTool('insertLink', {
		...
		onElementSelect: {
			...
			action: function(event, $element, editorScope){
				...
				var reLinkButton = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" tabindex="-1" unselectable="on"><i class="glyphicon glyphicon-edit icon-edit"></i></button>');
				...
				var unLinkButton = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" tabindex="-1" unselectable="on"><i class="glyphicon glyphicon-remove"></i></button>');
